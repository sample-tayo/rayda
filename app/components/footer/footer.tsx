...
const Footer = () => {
  return (
    <footer className=" p-8 pt-20 pb-4 lg:px-32">
      <div className="container mx-auto flex lg:flex-row justify-between items-start flex-col gap-8">
        {/* Column 1 */}
        ...
        {/* Column 2 */}
        <div className=" flex lg:gap-12 gap-32 items-center justify-between">
